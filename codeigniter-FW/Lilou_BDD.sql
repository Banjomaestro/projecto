...
('NOVELLI', 'Jean-Christophe', 'novelli', "Passionné par tout ce qui se termine en -TIQUE. comme la zétéTIQUE ou les mathémaTIQUES, Jean-Christophe, tel un mousTIQUE saura vous piquer votre curiosité pour ces matières fantasTIQUES"),
